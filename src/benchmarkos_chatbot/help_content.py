...
DEFAULT_SECTIONS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "examples": [
            ...
            "Show me Amazon's revenue forecast using ARIMA",
            "Forecast Apple's net income using ensemble methods",
        ],
        "delivers": "Historical growth rates (3-5 years), segment breakdown, growth drivers, ML forecasts (ARIMA/Prophet/ETS/LSTM/Transformer), comprehensive sources with clickable links.",
    },
    {
        "icon": "🔮",
        "title": "ML Forecasting",
        "command": "Forecast [TICKER]'s [metric] using [method]",
        "purpose": "Get advanced ML-based forecasts for revenue, earnings, and cash flow using ARIMA, Prophet, ETS, LSTM, GRU, Transformer, or ensemble methods.",
        "examples": [
            "What's the revenue forecast for Microsoft?",
        ...
        "delivers": "ML-based forecasts (ARIMA/Prophet/ETS/LSTM/GRU/Transformer/Ensemble), 95% confidence intervals, model details, accuracy estimates, comprehensive sources with clickable links.",
    },
    {
        "icon": "💵",
