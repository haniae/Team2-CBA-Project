...
_SP500_TICKERS = [
    ...
    "ADSK", "AEP", "AES", "AFL", "AIG", "AIZ", "AJG", "AKAM", "ALB", "ALGN",
    "ALL", "AMAT", "AMCR", "AMD", "AME", "AMGN", "AMP", "AMT", "AMZN", "ANET",
    "ANSS", "AON", "AOS", "APA", "APD", "APH", "APTV", "ARE", "ATO", "AVB",
    "AVGO", "AVY", "AXON", "AXP", "AZO", "BA", "BAC", "BALL", "BAX", "BBWI",
    "BBY", "BDX", "BEN", "BF-B", "BIIB", "BIO", "BK", "BKNG", "BKR", "BLDR",
    "BLK", "BMY", "BR", "BRK-B", "BRO", "BSX", "BWA", "BXP", "C", "CAG",
    "CAH", "CARR", "CAT", "CB", "CBOE", "CBRE", "CCI", "CCL", "CDAY", "CDNS",
    "CDW", "CE", "CERN", "CF", "CFG", "CHD", "CHRW", "CHTR", "CI", "CL",
    "CLX", "CMCSA", "CME", "CMG", "CMI", "CMS", "CNC", "CNP", "COF", "COO",
    "COP", "COST", "CPB", "CPRT", "CRL", "CRM", "CSCO", "CSGP", "CSX", "CTAS",
    ...
    "FDX", "FE", "FFIV", "FIS", "FISV", "FITB", "FL", "FLS", "FLT", "FMC",
    "FOX", "FOXA", "FRT", "FTNT", "FTV", "GD", "GE", "GEHC", "GEN", "GILD",
    "GIS", "GL", "GLW", "GM", "GNRC", "GOOG", "GOOGL", "GPC", "GPN", "GRMN",
    "GS", "GWW", "HAL", "HAS", "HBAN", "HCA", "HD", "HES", "HIG", "HII",
    "HLT", "HOG", "HOLX", "HON", "HPE", "HPQ", "HRL", "HSIC", "HST", "HSY",
    ...
    "KR", "L", "LBRDK", "LDOS", "LEN", "LH", "LHX", "LIN", "LKQ", "LLY",
    ...
    "RTX", "SBAC", "SBUX", "SCHW", "SEDG", "SEE", "SHW", "SJM", "SLB", "SNA",
    ...
    "VFC", "VICI", "VLO", "VMC", "VRSK", "VRSN", "VRTX", "VTR", "VZ", "WAB",
    "WAT", "WBA", "WBD", "WDC", "WEC", "WELL", "WFC", "WM", "WMB", "WMT",
    "WRB", "WRK", "WY", "WYNN", "XEL", "XOM", "XRAY", "XYL", "YUM", "ZBRA",
    "ZBH", "ZION", "ZTS"
]
